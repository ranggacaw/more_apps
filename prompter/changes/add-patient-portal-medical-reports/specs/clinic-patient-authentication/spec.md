...
**Reason**: Patient portal medical reports require authenticated patient access to the patient's own records.
**Migration**: Replace staff-only login rejection with role-aware staff and patient authentication while keeping operational staff routes protected from patient access.
